...
class DetailsWindow(tk.Toplevel):
    def __init__(self, mainWindow):
        ...
        self.detailsHandler = detailsHandler.DetailsHandler(self,
                                                            background="black")
        self.detailsHandler.grid(row="10",
                                 column="1",
                                 columnspan="19",
                                 sticky="news")
        ...
        self.geometry(
            "%sx%s+%s+%s" %
            (settings.detailsWindowWidth, settings.detailsWindowHeight,
             settings.detailsWindowX, settings.detailsWindowY))
        self.update_idletasks()

        self.topLabel = tk.Label(self,
                                 text=tr("Pilot Breakdown"),
                                 fg="white",
                                 background="black")
